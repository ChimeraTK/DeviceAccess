  ...
  class SubdeviceRegisterAccessor : public NDRegisterAccessor<int32_t> {
   public:
    SubdeviceRegisterAccessor(boost::shared_ptr<SubdeviceBackend> backend, const std::string& registerPathName,
        boost::shared_ptr<NDRegisterAccessor<int32_t>> accChipSelect,
   ...
   protected:
    ...
    boost::shared_ptr<NDRegisterAccessor<int32_t>> _accChipSelect;          // chip select register, if present
    boost::shared_ptr<NDRegisterAccessor<int32_t>> _accAddress;             // address register, if present
    boost::shared_ptr<NDRegisterAccessor<int32_t>> _accWriteDataArea;       // write data or write area register
    ...
    boost::shared_ptr<NDRegisterAccessor<int32_t>> _accReadData;            // read data (area not supported)
