...
namespace ChimeraTK::LNMBackend {
  ...
  /** SetDescription Plugin: Overwrites the engineering unit and/or description of the accessor without
   *  changing any other behaviour. The values can be set independently:
