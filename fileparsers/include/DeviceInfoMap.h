  ...
  public:
    ...
    public:
      ...
      DeviceInfoMap::DeviceInfo
          _errorDevice1; /**< Detailed information about first device that
                            generate error or warning */
      DeviceInfoMap::DeviceInfo
          _errorDevice2; /**< Detailed information about second device that
                            generate error or warning */
    ...
    public:
       ...
       * problem
       */
      ErrorElem(TYPE infoType, DMAP_FILE_ERR errorType,
...
protected:
  std::vector<DeviceInfo>
      _deviceInfoElements;   /**< vector storing parsed contents of DMAP file*/
  std::string _dmapFileName; /**< name of DMAP file*/
  std::vector<std::string>
      _pluginLibraries; ///< Names of the so files with the plugins
