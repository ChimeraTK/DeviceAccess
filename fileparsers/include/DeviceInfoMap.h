...
namespace ChimeraTK {
   ...
   public:
    ...
    class DeviceInfo {
     public:
      ...
      std::string uri; /**< uri which describes the device (or name of the device file in /dev in backward compatibility
                          mode)*/
     ...
     public:
      ...
      class ErrorElem {
       public:
        ...
        DeviceInfoMap::DeviceInfo _errorDevice1; /**< Detailed information about first device that generate error or
                                                    warning */
        DeviceInfoMap::DeviceInfo _errorDevice2; /**< Detailed information about second device that generate error or
                                                    warning */
  ...
  /**
   * @typedef Introduce specialisation of shared_pointer template for pointers to RegisterInfoMap object as a
