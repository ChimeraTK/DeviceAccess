...
namespace ChimeraTK {
  ...
  class DMapFilesParser {
   ...
   private:
    ...
    std::vector<std::pair<DeviceInfoMap::DeviceInfo, RegisterInfoMapPointer>> _dmapElements; /**< vector composed of
   ...
   public:
     ...
     */
    void getRegisterInfo(std::string dev_name, const std::string& reg_name, std::string& dev_file,
    ...
    void getRegisterInfo(
        std::string dev_name, const std::string& reg_name, std::string& dev_file, RegisterInfoMap::RegisterInfo& elem);
    /**
     ...
     *  <pre>dmapFile::dRegisterInfo myDeviceInfo = myDmapFilesParser->getdMapFileElem(deviceName); //creates a
     * copy</pre> instead of <pre>dmapFile::dRegisterInfo const & myDeviceInfo =
     * myDmapFilesParser->getdMapFileElem(deviceName); //does not create a copy</pre>
     */
     ...
     *
     */
    bool check(DeviceInfoMap::ErrorList::ErrorElem::TYPE dlevel, RegisterInfoMap::ErrorList::ErrorElem::TYPE mlevel,
        DeviceInfoMap::ErrorList& err, RegisterInfoMap::ErrorList& map_err);
    /**
