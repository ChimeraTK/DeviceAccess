...
public:
  ...
  public:
    ...
    MetaData(
        std::string const &the_name = std::string(),   // an empty string
  ...
  public:
    ...
    RegisterInfo(std::string const &name_ = std::string(), // an empty string
                 uint32_t nElements_ = 0, uint32_t address_ = 0,
                 uint32_t nBytes_ = 0, uint32_t bar_ = 0, uint32_t width_ = 32,
                 int32_t nFractionalBits_ = 0, bool signedFlag_ = true,
                 std::string const &module_ = std::string(),
                 uint32_t nChannels_ = 1, bool is2DMultiplexed_ = false,
  ...
  public:
    ...
    public:
      ...
      RegisterInfo
          _errorRegister1; /**< Detailed information about first register that
                              generate error or warning */
      RegisterInfo
          _errorRegister2; /**< Detailed information about second register that
                              generate error or warning */
       ...
       */
      ErrorElem(TYPE info_type, MAP_FILE_ERR e_type, const RegisterInfo &reg_1,
                const RegisterInfo &reg_2, const std::string &file_name);
   ...
   *
   */
  void getMetaData(const std::string &metaDataName,
  ...
  public:
    ...
    const RegisterInfoMap::RegisterInfo &operator*() {
      return *static_cast<const RegisterInfoMap::RegisterInfo *>(
          theIterator.get().get());
    }
    boost::shared_ptr<const RegisterInfoMap::RegisterInfo> operator->() {
      return boost::static_pointer_cast<const RegisterInfoMap::RegisterInfo>(
          theIterator.get());
    }
  ...
  public:
    ...
    RegisterInfoMap::RegisterInfo &operator*() {
      return *static_cast<RegisterInfoMap::RegisterInfo *>(
          theIterator.get().get());
    }
    boost::shared_ptr<RegisterInfoMap::RegisterInfo> operator->() {
      return boost::static_pointer_cast<RegisterInfoMap::RegisterInfo>(
          theIterator.get());
    }
  ...
  getRegistersInModule(std::string const &moduleName);
