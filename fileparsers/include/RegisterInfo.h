...
public:
  ...
  public:
    ...
    DataDescriptor(FundamentalType fundamentalType, bool isIntegral = false,
                   bool isSigned = false, size_t nDigits = 0,
                   size_t nFractionalDigits = 0,
...
inline RegisterInfo::FundamentalType
RegisterInfo::DataDescriptor::fundamentalType() const {
...
inline RegisterInfo::DataDescriptor::DataDescriptor(
    FundamentalType fundamentalType_, bool isIntegral_, bool isSigned_,
    size_t nDigits_, size_t nFractionalDigits_, DataType rawDataType_,
    DataType transportLayerDataType_)
    : _fundamentalType(fundamentalType_), _rawDataType(rawDataType_),
      _transportLayerDataType(transportLayerDataType_),
      _isIntegral(isIntegral_), _isSigned(isSigned_), _nDigits(nDigits_),
