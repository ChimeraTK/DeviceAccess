...
namespace ChimeraTK {
  ...
  class findRegisterByName_pred {
   ...
   public:
    findRegisterByName_pred(const std::string& name, const std::string& module) : _name(name), _module(module) {}
  ...
  class copmaredRegisterInfosByName_functor {
   public:
    bool operator()(const std::pair<DeviceInfoMap::DeviceInfo, RegisterInfoMapPointer>& first,
        const std::pair<DeviceInfoMap::DeviceInfo, RegisterInfoMapPointer>& second) {
