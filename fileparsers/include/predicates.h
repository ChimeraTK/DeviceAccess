...
public:
  ...
  bool operator()(const std::pair<DeviceInfoMap::DeviceInfo,
                                  RegisterInfoMapPointer> &elem) {
    if (elem.first.deviceName == _name)
      return true;
    return false;
  }
};
...
public:
  bool operator()(const RegisterInfoMap::RegisterInfo &first,
                  const RegisterInfoMap::RegisterInfo &second) {
...
public:
  bool operator()(
      const std::pair<DeviceInfoMap::DeviceInfo, RegisterInfoMapPointer> &first,
      const std::pair<DeviceInfoMap::DeviceInfo, RegisterInfoMapPointer>
          &second) {
...
public:
  bool operator()(const DeviceInfoMap::DeviceInfo &first,
                  const DeviceInfoMap::DeviceInfo &second) {
...
public:
  compareModuleName_pred(std::string const &moduleName)
