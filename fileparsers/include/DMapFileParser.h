...
protected:
  ...
  void parseForLoadLib(std::string file_name, std::string line,
                       uint32_t line_nr, DeviceInfoMapPointer dmap);
  void parseRegularLine(std::string file_name, std::string line,
                        uint32_t line_nr, DeviceInfoMapPointer dmap);
  void raiseException(std::string file_name, std::string line,
                      uint32_t line_nr);
  ...
  std::string absPathOfDMapContent(std::string dmapContent,
