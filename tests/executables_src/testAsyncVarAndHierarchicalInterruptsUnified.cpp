...
#define BOOST_TEST_MODULE AsyncVarAndHierarchicalInterruptsUnified
...
BOOST_AUTO_TEST_CASE(testRegisterAccessor) {
  ...
  // This is checking that there is no internal shared pointer loop which prevents the destructor from ever being called.
