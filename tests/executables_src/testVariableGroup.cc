...
struct TestModule : public ctk::ApplicationModule {
  ...
  struct MixedGroup : public ctk::VariableGroup {
    SCALAR_INPUT(int, consumingPush, "MV/m", ctk::UpdateMode::push);
    SCALAR_INPUT(int, consumingPush2, "MV/m", ctk::UpdateMode::push);
    SCALAR_INPUT(int, consumingPush3,  "MV/m", ctk::UpdateMode::push);
    SCALAR_INPUT(int, consumingPoll, "MV/m", ctk::UpdateMode::poll);
    SCALAR_INPUT(int, consumingPoll2, "MV/m", ctk::UpdateMode::poll);
    SCALAR_INPUT(int, consumingPoll3, "MV/m", ctk::UpdateMode::poll);
  };
  MixedGroup mixedGroup;

  SCALAR_OUTPUT(int, feedingPush, "MV/m");
  SCALAR_OUTPUT(int, feedingPush2, "MV/m");
  SCALAR_OUTPUT(int, feedingPush3,  "MV/m");
  SCALAR_OUTPUT(int, feedingPoll, "MV/m");
  SCALAR_OUTPUT(int, feedingPoll2, "MV/m");
  SCALAR_OUTPUT(int, feedingPoll3, "MV/m");
