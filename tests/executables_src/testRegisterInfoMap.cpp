...
public:
  mapFileTestSuite() : test_suite("RegisterInfoMap class test suite") {
    ...
    test_case *testInsertElement =
        BOOST_CLASS_TEST_CASE(&MapFileTest::testInsertElement, MapFileTestPtr);
    test_case *teestInsertMetadata =
        BOOST_CLASS_TEST_CASE(&MapFileTest::testInsertMetadata, MapFileTestPtr);
    test_case *testGetRegisterInfo = BOOST_CLASS_TEST_CASE(
        &MapFileTest::testGetRegisterInfo, MapFileTestPtr);
    test_case *testGetMetaData =
        BOOST_CLASS_TEST_CASE(&MapFileTest::testGetMetaData, MapFileTestPtr);
    test_case *testCheckRegistersOfSameName = BOOST_CLASS_TEST_CASE(
        &MapFileTest::testCheckRegistersOfSameName, MapFileTestPtr);
    test_case *testCheckRegisterAddressOverlap = BOOST_CLASS_TEST_CASE(
        &MapFileTest::testCheckRegisterAddressOverlap, MapFileTestPtr);
    test_case *testMetadataCoutStreamOperator = BOOST_CLASS_TEST_CASE(
        &MapFileTest::testMetadataCoutStreamOperator, MapFileTestPtr);
    test_case *testRegisterInfoCoutStreamOperator = BOOST_CLASS_TEST_CASE(
        &MapFileTest::testRegisterInfoCoutStreamOperator, MapFileTestPtr);
    test_case *testErrElemTypeCoutStreamOperator = BOOST_CLASS_TEST_CASE(
        &MapFileTest::testErrElemTypeCoutStreamOperator, MapFileTestPtr);
    test_case *testErrorElemCoutStreamOperator = BOOST_CLASS_TEST_CASE(
        &MapFileTest::testErrorElemCoutStreamOperator, MapFileTestPtr);
    test_case *testErrorListCoutStreamOperator = BOOST_CLASS_TEST_CASE(
        &MapFileTest::testErrorListCoutStreamOperator, MapFileTestPtr);
    test_case *testMapFileCoutStreamOperator = BOOST_CLASS_TEST_CASE(
        &MapFileTest::testMapFileCoutStreamOperator, MapFileTestPtr);
    ...
    add(BOOST_CLASS_TEST_CASE(&MapFileTest::testGetRegistersInModule,
                              MapFileTestPtr));
  }
};
...
void MapFileTest::testInsertElement() {
  ...
  for (it = dummyMapFile.begin(), index = 0;
       (it != dummyMapFile.end()) && (index < 3); ++it, ++index) {
...
void MapFileTest::testInsertMetadata() {
  ...
  ChimeraTK::RegisterInfoMap::MetaData metaData3("TEST",
...
void MapFileTest::testGetRegisterInfo() {
  ...
  BOOST_CHECK(compareRegisterInfoents(RegisterInfoent1, retrievedDeviceInfo) ==
              true);

  dummyMapFile.getRegisterInfo("COMMON_REGISTER_NAME", retrievedDeviceInfo,
                               "Module1");
  BOOST_CHECK(compareRegisterInfoents(RegisterInfoentModule1,
                                      retrievedDeviceInfo) == true);

  dummyMapFile.getRegisterInfo("COMMON_REGISTER_NAME", retrievedDeviceInfo,
                               "Module2");
  BOOST_CHECK(compareRegisterInfoents(RegisterInfoentModule2,
                                      retrievedDeviceInfo) == true);
  ...
  BOOST_CHECK(compareRegisterInfoents(RegisterInfoent1, retrievedDeviceInfo) ==
              true);
  BOOST_CHECK_THROW(dummyMapFile.getRegisterInfo(3, retrievedDeviceInfo),
                    ChimeraTK::logic_error);
}
...
void MapFileTest::testCheckRegistersOfSameName() {
  ...
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent1(
      "TEST_REGISTER_NAME_1", 1, 0, 4, 0);
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent2(
      "TEST_REGISTER_NAME_1", 1, 4, 4, 1);
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent3(
      "TEST_REGISTER_NAME_1", 1, 8, 4, 0);
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent4(
      "TEST_REGISTER_NAME_2", 1, 8, 4, 2);
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoentModule1(
  ...
  dummyMapFile.check(errorList,
                     ChimeraTK::RegisterInfoMap::ErrorList::ErrorElem::WARNING);
  ...
  for (errorIterator = errorList.errors.begin();
       errorIterator != errorList.errors.end(); ++errorIterator) {
    BOOST_CHECK(errorIterator->_errorType ==
                ChimeraTK::RegisterInfoMap::ErrorList::ErrorElem::
                    NONUNIQUE_REGISTER_NAME);
    BOOST_CHECK(errorIterator->_type ==
                ChimeraTK::RegisterInfoMap::ErrorList::ErrorElem::ERROR);
  }
...
void MapFileTest::testCheckRegisterAddressOverlap() {
  ...
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent1(
      "TEST_REGISTER_NAME_1", 1, 0, 4, 0);
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent2(
      "TEST_REGISTER_NAME_2", 1, 11, 4, 0);
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent3(
      "TEST_REGISTER_NAME_3", 1, 10, 4, 0);
  // 4 overlaps with 1, but is not next to it in the list
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent4(
      "TEST_REGISTER_NAME_4", 1, 3, 4, 0);
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent5("THE_WHOLE_MODULE",
                                                            2, 16, 8, 0);
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent6(
      "REGISTER_1", 1, 16, 4, 0, 32, 0, true, "THE_MODULE");
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent7(
      "REGISTER_2", 1, 20, 4, 0, 32, 0, true, "THE_MODULE");
...
void MapFileTest::testMetadataCoutStreamOperator() {
  ChimeraTK::RegisterInfoMap::MetaData meta_data("metadata_name",
                                                 "metadata_value");
...
void MapFileTest::testRegisterInfoCoutStreamOperator() {
  ...
  expected_stream << "Some_Register"
                  << " 0x" << std::hex << 0 << " 0x" << 0 << " 0x" << 0 << " 0x"
                  << 0 << std::dec << " 32 0 true <noModule> RW FIXED_POINT";
  expected_stream << "TEST_REGISTER_NAME_2"
                  << " 0x" << std::hex << 2 << " 0x" << 4 << " 0x" << 8 << " 0x"
                  << 1 << std::dec << " 18 3 false SomeModule RW FIXED_POINT";
  std::stringstream actual_stream;
...
void MapFileTest::testErrorElemCoutStreamOperator() {
  ...
  dummyMapFile1.check(
      errorList1, ChimeraTK::RegisterInfoMap::ErrorList::ErrorElem::WARNING);
  std::list<ChimeraTK::RegisterInfoMap::ErrorList::ErrorElem>::iterator
      errorIterator1;
...
inline void MapFileTest::testErrorListCoutStreamOperator() {
  ...
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent1(
      "TEST_REGISTER_NAME_1", 1, 0, 4, 0);
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent2(
      "TEST_REGISTER_NAME_2", 1, 4, 4, 0);
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent3(
      "TEST_REGISTER_NAME_1", 1, 10, 4, 0);
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent4(
      "TEST_REGISTER_NAME_3", 1, 12, 4, 0);
...
void MapFileTest::testMapFileCoutStreamOperator() {
  ...
  ChimeraTK::RegisterInfoMap::RegisterInfo RegisterInfoent3(
      "TEST_REGISTER_NAME_3", 1, 12, 4, 1, 32, 0, true, "TEST_MODULE", 1, false,
      RegisterInfoMap::RegisterInfo::Access::READ,
  ...
  expected_stream << "TEST_REGISTER_NAME_2"
                  << " 0x" << std::hex << 2 << " 0x" << 4 << " 0x" << 8 << " 0x"
                  << 1 << std::dec << " 18 3 false TEST_MODULE RW FIXED_POINT"
                  << std::endl;
  expected_stream << "TEST_REGISTER_NAME_3"
                  << " 0x" << std::hex << 1 << " 0x" << 12 << " 0x" << 4
                  << " 0x" << 1 << std::dec
...
void MapFileTest::testRegisterInfo() {
  ...
  BOOST_CHECK(myRegisterInfo.getDataDescriptor().fundamentalType() ==
  ...
  BOOST_CHECK(myRegisterInfo.getDataDescriptor().nFractionalDigits() ==
              2); // 2^5 = 32 -> 2 digits
  BOOST_CHECK(myRegisterInfo.getDataDescriptor().nDigits() ==
              7); // 2^(18-5) = 8192 -> 4 digits + 1 for the dot + 2
                  // fractional

  // test a signed integer
  ChimeraTK::RegisterInfoMap::RegisterInfo myRegisterInfo2(
      "ANOTHER_NAME",
      1,          // nElements
      0xDEADBEEF, // address
      4,          // size
  ...
  BOOST_CHECK(myRegisterInfo2.getDataDescriptor().fundamentalType() ==
              ChimeraTK::RegisterInfo::FundamentalType::numeric);
  BOOST_CHECK(myRegisterInfo2.getDataDescriptor().isIntegral() == true);
  BOOST_CHECK(myRegisterInfo2.getDataDescriptor().isSigned() == true);
  BOOST_CHECK(myRegisterInfo2.getDataDescriptor().nDigits() ==
              8); // 2^23 = 8388608 -> 7 digits + 1 for the sign

  // ... and an unsigned integer (otherwise identical)
  ChimeraTK::RegisterInfoMap::RegisterInfo myRegisterInfo3(
      "ANOTHER_NAME",
      1,          // nElements
      0xDEADBEEF, // address
      4,          // size
  ...
  BOOST_CHECK(myRegisterInfo3.getDataDescriptor().fundamentalType() ==
              ChimeraTK::RegisterInfo::FundamentalType::numeric);
  ...
  BOOST_CHECK(myRegisterInfo3.getDataDescriptor().nDigits() ==
              7); // 2^23 = 8388608 -> 7 digits
  ...
  BOOST_CHECK(myRegisterInfo4.getDataDescriptor().fundamentalType() ==
              ChimeraTK::RegisterInfo::FundamentalType::boolean);
  ...
  BOOST_CHECK(myRegisterInfo5.getDataDescriptor().fundamentalType() ==
              ChimeraTK::RegisterInfo::FundamentalType::nodata);
}

void MapFileTest::testGetRegistersInModule() {
  ChimeraTK::RegisterInfoMap someMapFile("some.map");
  ChimeraTK::RegisterInfoMap::RegisterInfo module0_register1(
      "REGISTER_1", 1, 0x0, 4, 0, 32, 0, true, "MODULE_BAR0");
  ChimeraTK::RegisterInfoMap::RegisterInfo module1_register1(
      "REGISTER_1", 1, 0x0, 4, 1, 32, 0, true, "MODULE_BAR1");
  ChimeraTK::RegisterInfoMap::RegisterInfo module0_aregister2(
      "A_REGISTER_2", 1, 0x4, 4, 0, 32, 0, true, "MODULE_BAR0");
  ChimeraTK::RegisterInfoMap::RegisterInfo module1_aregister2(
      "A_REGISTER_2", 1, 0x4, 4, 1, 32, 0, true, "MODULE_BAR1");
  ChimeraTK::RegisterInfoMap::RegisterInfo module0_register3(
      "REGISTER_3", 1, 0x8, 4, 0, 32, 0, true, "MODULE_BAR0");
  ChimeraTK::RegisterInfoMap::RegisterInfo module1_register3(
      "REGISTER_3", 1, 0x8, 4, 1, 32, 0, true, "MODULE_BAR1");
  ChimeraTK::RegisterInfoMap::RegisterInfo module0_register4(
      "REGISTER_4", 1, 0xC, 4, 0, 32, 0, true, "MODULE_BAR0");
  ChimeraTK::RegisterInfoMap::RegisterInfo module1_register4(
      "REGISTER_4", 1, 0xC, 4, 1, 32, 0, true, "MODULE_BAR1");
  ...
  std::list<ChimeraTK::RegisterInfoMap::RegisterInfo> resultList =
      someMapFile.getRegistersInModule("MODULE_BAR1");
  ...
  std::list<ChimeraTK::RegisterInfoMap::RegisterInfo>::const_iterator
      resultIter;
  std::list<ChimeraTK::RegisterInfoMap::RegisterInfo>::const_iterator
      referenceIter;
  for (resultIter = resultList.begin(), referenceIter = referenceList.begin();
       (resultIter != resultList.end()) &&
       (referenceIter != referenceList.end());
