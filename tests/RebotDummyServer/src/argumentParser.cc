...
struct Argument {
  ...
  Argument(std::string shortName, std::string longName) : _shortName(shortName), _longName(longName) {}
};
...
std::string getArgumentValue(Argument& argument, char** argumentArray) {
  ...
  else if(argument._shortName == *argumentArray || argument._longName == *argumentArray) {
