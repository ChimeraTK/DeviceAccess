...
private:
  ...
  void readDMAViaIoctl(uint8_t bar, uint32_t address, int32_t *data,
                       size_t sizeInBytes);
  void readDMAViaStruct(uint8_t bar, uint32_t address, int32_t *data,
                        size_t sizeInBytes);
  ...
  void writeWithStruct(uint8_t bar, uint32_t address, int32_t const *data,
                       size_t sizeInBytes);
  /** This function is the same for one or multiple words */
  void directWrite(uint8_t bar, uint32_t address, int32_t const *data,
                   size_t sizeInBytes);

  void readInternal(uint8_t bar, uint32_t address, int32_t *data);
  void readWithStruct(uint8_t bar, uint32_t address, int32_t *data,
                      size_t sizeInBytes);
  /** This function is the same for one or multiple words */
  void directRead(uint8_t bar, uint32_t address, int32_t *data,
                  size_t sizeInBytes);
