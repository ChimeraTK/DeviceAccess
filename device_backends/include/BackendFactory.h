...
namespace ChimeraTK {
  ...
  class BackendFactory {
   ...
   protected:
    ...
    // If a plugins fails to register, this function is bound to an error string and stored in the creatorMap. It later
    // it is tried to open the backend, an exception with this error message is thrown.
