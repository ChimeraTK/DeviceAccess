...
public:
  ...
  virtual void write(uint8_t /*bar*/, uint32_t /*address*/,
  ...
  virtual void read(const std::string &, const std::string &, int32_t *,
                    size_t = 0, uint32_t = 0) {
    throw ChimeraTK::logic_error("The depcrecated DeviceBackend::read() "
                                 "function is not implemented by this backend. "
                                 "Use the Device frontend instead!");
  ...
  virtual void write(const std::string &, const std::string &, int32_t const *,
                     size_t = 0, uint32_t = 0) {
    throw ChimeraTK::logic_error("The depcrecated DeviceBackend::write() "
                                 "function is not implemented by this backend. "
                                 "Use the Device frontend instead!");
  ...
  virtual boost::shared_ptr<const RegisterInfoMap> getRegisterMap() const {
    ...
    throw ChimeraTK::logic_error(
        "Obtaining a register map is not supported by this backend.");
  }
