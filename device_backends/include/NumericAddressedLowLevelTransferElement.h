   ...
   public:
    ...
    TransferFuture doReadTransferAsync() override { // LCOV_EXCL_LINE
      ...
      throw ChimeraTK::logic_error(
          "NumericAddressedLowLevelTransferElement::readAsync() is not implemented"); // LCOV_EXCL_LINE
    }                                                                                 // LCOV_EXCL_LINE
    ...
    /** Change the start address (inside the bar given in the constructor) and number of words of this accessor,  and
     * set the shared flag. */
    ...
    boost::shared_ptr<TransferElement> makeCopyRegisterDecorator() override { // LCOV_EXCL_LINE
      throw ChimeraTK::logic_error(
          "NumericAddressedLowLevelTransferElement::makeCopyRegisterDecorator() is not implemented"); // LCOV_EXCL_LINE
    }                                                                                                 // LCOV_EXCL_LINE
