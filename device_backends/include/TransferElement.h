...
public:
  ...
  TransferElement(std::string const &name = std::string(),
      ...
      : _name(name), _unit(unit), _description(description),
...
public:
   ...
   */
  virtual bool
  mayReplaceOther(const boost::shared_ptr<TransferElement const> &other) const {
  ...
  getHardwareAccessingElements() = 0;
   ...
   * abstraction!
   */
  virtual std::list<boost::shared_ptr<TransferElement>>
  getInternalElements() = 0;
   ...
   */
  virtual void
  replaceTransferElement(boost::shared_ptr<TransferElement> newElement) {
   ...
   */
  virtual void setPersistentDataStorage(
      boost::shared_ptr<ChimeraTK::PersistentDataStorage>) {}
 ...
 */
template <> struct hash<ChimeraTK::TransferElementID> {
...
template <> struct less<ChimeraTK::TransferElementID> {
  ...
  bool operator()(const ChimeraTK::TransferElementID &a,
                  const ChimeraTK::TransferElementID &b) const {
    return a._id < b._id;
  }
};
} // namespace std
