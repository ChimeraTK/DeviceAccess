...
foreach(servertype ${servertypes})
  install(DIRECTORY "${PROJECT_BINARY_DIR}/${servertype}/settings" DESTINATION "${DESTDIR}/${servertype}")
  install(DIRECTORY "${PROJECT_BINARY_DIR}/${servertype}/templates" DESTINATION "${DESTDIR}/${servertype}" USE_SOURCE_PERMISSIONS)
  file(GLOB thefiles LIST_DIRECTORIES no "${PROJECT_BINARY_DIR}/${servertype}/*")
