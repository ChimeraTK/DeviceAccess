...
class ExampleBackend : public ChimeraTK::DeviceBackendImpl {
 ...
 public:
   ...
   * This causes the constructor to be executed when the library is loaded, end
  ...
  /**
   *  The one static instance of the registerer. Currently we keep it public so
   * there is an object which can be used in the client code. This trick is
   * needed to force the library to be loaded as long as the loading mechanism
   * is not implemented into the dmap file (see DeviceClient.cpp how to do it).
   */
