...
BaseDevice* ExampleDevice::createInstance(std::string host, std::string interface, std::list<std::string> parameters) {
#ifdef _DEBUG
	std::cout<<"example createInstance"<<std::endl;
#endif
	return new ExampleDevice(host,interface,parameters);
}
