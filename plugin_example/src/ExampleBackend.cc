...
ExampleBackend::~ExampleBackend() { close(); }
...
void ExampleBackend::open() { _opened = true; }

void ExampleBackend::close() { _opened = false; }

// We do not have a suitable buffering register accessor, so we throw an
// exception.
template <typename UserType>
boost::shared_ptr<NDRegisterAccessor<UserType>>
ExampleBackend::getRegisterAccessor_impl(
    const ChimeraTK::RegisterPath & /*registerPathName*/,
    size_t /*wordOffsetInRegister*/, size_t /*numberOfWords*/,
