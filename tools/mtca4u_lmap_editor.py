...
# create the menu
    def makeMenu(self):
        ...
        self._fileOpenAction = QAction("&Open logical name mapping file...", None)
        self.connect(self._fileOpenAction, SIGNAL('triggered()'), self.openFile)
        fileMenu.addAction(self._fileOpenAction)

        self._fileSaveAction = QAction("&Save logical name mapping file...", None)
        self.connect(self._fileSaveAction, SIGNAL('triggered()'), self.saveFile)
