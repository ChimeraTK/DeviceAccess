...
namespace ChimeraTK {
  ...
  std::vector<size_t> RegisterInfo::getQualifiedAsyncId() const {
    return _impl->getQualifiedAsyncId();
  }

  /********************************************************************************************************************/

  std::set<std::string> RegisterInfo::getTags() const {
    return _impl->getTags();
  }

  /********************************************************************************************************************/

  std::string RegisterInfo::getUnit() const {
    return _impl->getUnit();
  }

  /********************************************************************************************************************/

  std::string RegisterInfo::getDescription() const {
