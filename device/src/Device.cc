...
boost::shared_ptr<const RegisterInfoMap> Device::getRegisterMap() const {
  checkPointersAreNotNull();
  auto castedBackend = boost::dynamic_pointer_cast<NumericAddressedBackend>(
...
boost::shared_ptr<RegisterAccessor>
Device::getRegisterAccessor(const std::string &regName,
                            const std::string &module) const {
  checkPointersAreNotNull();
  return boost::shared_ptr<RegisterAccessor>(new RegisterAccessor(
      _deviceBackendPointer, RegisterPath(module) / regName));
}

/********************************************************************************************************************/

std::list<RegisterInfoMap::RegisterInfo>
Device::getRegistersInModule(const std::string &moduleName) const {
  checkPointersAreNotNull();
  auto castedBackend = boost::dynamic_pointer_cast<NumericAddressedBackend>(
      _deviceBackendPointer);
  if (!castedBackend) {
...
void Device::readReg(const std::string &regName, int32_t *data, size_t dataSize,
...
void Device::readReg(const std::string &regName, const std::string &regModule,
  ...
  if (addRegOffset % sizeof(int32_t) != 0) {
    throw ChimeraTK::logic_error(
        "Wrong additional register offset - must be dividable by 4");
  }
  auto vec = read<int32_t>(RegisterPath(regModule) / regName,
...
void Device::writeReg(const std::string &regName, const std::string &regModule,
  ...
  write(RegisterPath(regModule) / regName, vec, addRegOffset / sizeof(int32_t),
        true);
}

/********************************************************************************************************************/

void Device::readDMA(const std::string &regName, int32_t *data, size_t dataSize,
                     uint32_t addRegOffset) const {
...
void Device::readDMA(const std::string &regName, const std::string &regModule,
                     int32_t *data, size_t dataSize,
                     uint32_t addRegOffset) const {
  std::cerr << "***************************************************************"
               "**********************************"
...
void Device::writeDMA(const std::string &regName, const std::string &regModule,
                      int32_t const *data, size_t dataSize,
                      uint32_t addRegOffset) {
  std::cerr << "***************************************************************"
               "**********************************"
