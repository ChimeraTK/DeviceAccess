...
#pragma GCC diagnostic pop
  ...
  void Device::open(
      boost::shared_ptr<DeviceBackend>, boost::shared_ptr<ChimeraTK::RegisterInfoMap>&) { // LCOV_EXCL_LINE
    std::cerr << "*************************************************************************************************"
              << std::endl; // LCOV_EXCL_LINE
    ...
    std::cerr << "** Signature:                                                                                  **"
              << std::endl; // LCOV_EXCL_LINE
    std::cerr << "** Device::open(boost::shared_ptr<DeviceBackend>, boost::shared_ptr<ChimeraTK::RegisterInfoMap>&) **"
              << std::endl; // LCOV_EXCL_LINE
    std::cerr << "**                                                                                             **"
              << std::endl; // LCOV_EXCL_LINE
    std::cerr << "** Use open() by alias name instead!                                                           **"
