...
public:
  ...
  ScalarRegisterAccessor<UserType> getScalarRegisterAccessor(
      const RegisterPath &registerPathName, size_t wordOffsetInRegister = 0,
  ...
  template <typename UserType>
  OneDRegisterAccessor<UserType> getOneDRegisterAccessor(
      const RegisterPath &registerPathName, size_t numberOfWords = 0,
  ...
  TwoDRegisterAccessor<UserType> getTwoDRegisterAccessor(
      const RegisterPath &registerPathName, size_t numberOfElements = 0,
  ...
  template <typename UserType>
  UserType read(const RegisterPath &registerPathName,
                const AccessModeFlags &flags = AccessModeFlags({})) const;
  ...
  template <typename UserType>
  std::vector<UserType>
  read(const RegisterPath &registerPathName, size_t numberOfWords,
       size_t wordOffsetInRegister = 0,
       const AccessModeFlags &flags = AccessModeFlags({})) const;
   ...
   * function only works for 1D registers.*/
  template <typename UserType>
  void write(const RegisterPath &registerPathName, UserType value,
  ...
  template <typename UserType>
  [[deprecated("Use new signature instead!")]] std::vector<UserType>
  read(const RegisterPath &registerPathName, size_t numberOfWords,
   ...
   *  @todo Add printed runtime warning. Deprecated since version 0.12 */
  template <typename UserType>
  [[deprecated("Use new signature instead!")]] void
  write(const RegisterPath &registerPathName, UserType value,
  ...
  template <typename UserType>
  [[deprecated("Use new signature instead!")]] void
  write(const RegisterPath &registerPathName, std::vector<UserType> &vector,
  ...
  template <typename UserType>
  [[deprecated("Use new signature instead!")]] ScalarRegisterAccessor<UserType>
  getScalarRegisterAccessor(const RegisterPath &registerPathName,
   ...
   *  @todo Add printed runtime warning. Deprecated since version 0.12 */
  template <typename UserType>
  [[deprecated("Use new signature instead!")]] OneDRegisterAccessor<UserType>
  getOneDRegisterAccessor(const RegisterPath &registerPathName,
   ...
   *  @todo Add printed runtime warning after release of version 0.9
   */
  [[deprecated("Use read() instead!")]] virtual void
  readReg(uint32_t regOffset, int32_t *data, uint8_t bar) const;
   ...
   *  @todo Add printed runtime warning after release of version 0.9
   */
  [[deprecated("Use write() instead!")]] virtual void
  writeReg(uint32_t regOffset, int32_t data, uint8_t bar);
   ...
   */
  [[deprecated("Use read() instead!")]] virtual void
  readArea(uint32_t regOffset, int32_t *data, size_t size, uint8_t bar) const;
   ...
   */
  [[deprecated("Use write() instead!")]] virtual void
  writeArea(uint32_t regOffset, int32_t const *data, size_t size, uint8_t bar);
   ...
   */
  [[deprecated("Use write() instead!")]] virtual void
  readReg(const std::string &regName, int32_t *data, size_t dataSize = 0,
   ...
   */
  [[deprecated("Use read() instead!")]] virtual void
  readReg(const std::string &regName, const std::string &regModule,
   ...
   */
  [[deprecated("Use write() instead!")]] virtual void
  writeReg(const std::string &regName, int32_t const *data, size_t dataSize = 0,
   ...
   */
  [[deprecated("Use write() instead!")]] virtual void
  writeReg(const std::string &regName, const std::string &regModule,
  ...
  getRegisterAccessor(const std::string &registerName,
   ...
   *  @todo Add printed runtime warning after release of version 0.9
   */
  [[deprecated("Use getRegisterCatalogue() instead!")]] std::list<
  ...
  [[deprecated("Use getRegisterCatalogue() instead and create accessors with "
               "get*RegisterAccessor() functions!")]] std::list<
      boost::shared_ptr<ChimeraTK::RegisterAccessor>>
   ...
   *  @todo Add printed runtime warning after release of version 0.9
   */
  [[deprecated("Use getRegisterCatalogue() instead!")]] boost::shared_ptr<
      const RegisterInfoMap>
  getRegisterMap() const;
   ...
   */
  [[deprecated(
      "Open by alias or device identifier string instead!")]] virtual void
  open(boost::shared_ptr<DeviceBackend> deviceBackend,
  ...
  [[deprecated("Use getTwoDRegisterAccessor() instead!")]] boost::shared_ptr<
      customClass>
  getCustomAccessor(const std::string &dataRegionName,
                    const std::string &module = std::string()) const;
  ...
  [[deprecated("Use getOneDRegisterAccessor() "
               "instead!")]] BufferingRegisterAccessor<UserType>
  getBufferingRegisterAccessor(const std::string &module,
   ...
   */
  template <typename UserType>
  [[deprecated("Use new signature instead!")]] TwoDRegisterAccessor<UserType>
  getTwoDRegisterAccessor(const std::string &module,
                          const std::string &registerName) const;
   ...
   */
  [[deprecated("Use read() instead!")]] virtual void
  readDMA(uint32_t regOffset, int32_t *data, size_t size, uint8_t bar) const;
   ...
   */
  [[deprecated("Use write() instead!")]] virtual void
  writeDMA(uint32_t regOffset, int32_t const *data, size_t size, uint8_t bar);
   ...
   */
  [[deprecated("Use read() instead!")]] virtual void
  readDMA(const std::string &regName, int32_t *data, size_t dataSize = 0,
          uint32_t addRegOffset = 0) const;
   ...
   */
  [[deprecated("Use read() instead!")]] virtual void
  readDMA(const std::string &regName, const std::string &regModule,
          int32_t *data, size_t dataSize = 0, uint32_t addRegOffset = 0) const;
   ...
   */
  [[deprecated("Use write() instead!")]] virtual void
  writeDMA(const std::string &regName, int32_t const *data, size_t dataSize = 0,
           uint32_t addRegOffset = 0);
   ...
   */
  [[deprecated("Use write() instead!")]] virtual void
  writeDMA(const std::string &regName, const std::string &regModule,
           int32_t const *data, size_t dataSize = 0, uint32_t addRegOffset = 0);
...
template <typename customClass>
boost::shared_ptr<customClass>
Device::getCustomAccessor(const std::string &dataRegionName,
  ...
  std::cerr << "***************************************************************"
               "**********************************"
            << std::endl; // LCOV_EXCL_LINE
  return customClass::createInstance(dataRegionName, module,
...
template <typename UserType>
ScalarRegisterAccessor<UserType>
Device::getScalarRegisterAccessor(const RegisterPath &registerPathName,
                                  size_t wordOffsetInRegister,
                                  const AccessModeFlags &flags) const {
  checkPointersAreNotNull();
  return ScalarRegisterAccessor<UserType>(
      _deviceBackendPointer->getRegisterAccessor<UserType>(
          registerPathName, 1, wordOffsetInRegister, flags));
}
...
Device::getScalarRegisterAccessor(const RegisterPath &registerPathName,
                                  ...
                                  bool enforceRawAccess) const {
  if (!enforceRawAccess) {
    return getScalarRegisterAccessor<UserType>(registerPathName,
                                               wordOffsetInRegister);
  } else {
    return getScalarRegisterAccessor<UserType>(
        registerPathName, wordOffsetInRegister,
...
template <typename UserType>
OneDRegisterAccessor<UserType> Device::getOneDRegisterAccessor(
...
template <typename UserType>
TwoDRegisterAccessor<UserType>
Device::getTwoDRegisterAccessor(const RegisterPath &registerPathName,
                                size_t numberOfElements, size_t elementsOffset,
                                const AccessModeFlags &flags) const {
  checkPointersAreNotNull();
...
template <typename UserType>
UserType Device::read(const RegisterPath &registerPathName,
                      const AccessModeFlags &flags) const {
...
template <typename UserType>
std::vector<UserType>
Device::read(const RegisterPath &registerPathName, size_t numberOfWords,
             size_t wordOffsetInRegister, const AccessModeFlags &flags) const {
  auto acc = getOneDRegisterAccessor<UserType>(registerPathName, numberOfWords,
...
template <typename UserType>
void Device::write(const RegisterPath &registerPathName, UserType value,
...
template <typename UserType>
void Device::write(const RegisterPath &registerPathName,
                   const std::vector<UserType> &vector,
                   size_t wordOffsetInRegister, const AccessModeFlags &flags) {
  auto acc = getOneDRegisterAccessor<UserType>(registerPathName, vector.size(),
                                               wordOffsetInRegister, flags);
  // the vector stays constant, but we have to work around so we can swap it and
  // later swap it back...
  std::vector<UserType> &mutable_vector =
      const_cast<std::vector<UserType> &>(vector);
...
Device::read(const RegisterPath &registerPathName, size_t numberOfWords,
  ...
  return read<UserType>(registerPathName, numberOfWords, wordOffsetInRegister,
                        (enforceRawAccess ? AccessModeFlags({AccessMode::raw})
                                          : AccessModeFlags({})));
}
...
template <typename UserType>
void Device::write(const RegisterPath &registerPathName,
                   std::vector<UserType> &vector, size_t wordOffsetInRegister,
                   bool enforceRawAccess) {
...
template <typename UserType>
BufferingRegisterAccessor<UserType>
Device::getBufferingRegisterAccessor(const std::string &module,
                                     const std::string &registerName) const {
  return getBufferingRegisterAccessor<UserType>(RegisterPath(module) /
                                                registerName);
}
...
template <typename UserType>
TwoDRegisterAccessor<UserType>
Device::getTwoDRegisterAccessor(const std::string &module,
                                const std::string &registerName) const {
  checkPointersAreNotNull();
  return TwoDRegisterAccessor<UserType>(
      _deviceBackendPointer->getRegisterAccessor<UserType>(
