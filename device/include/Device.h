...
namespace ChimeraTK {
  ...
  class Device {
   public:
    ...
    template<typename UserType>
    [[deprecated(
        "Use getScalarRegisterAccessor or getOneDRegisterAccessor instead!")]] BufferingRegisterAccessor<UserType>
     ...
     *  @todo Add printed runtime warning after release of version 0.9
     */
    [[deprecated("Use getScalarRegisterAccessor() or getOneDRegisterAccessor() instead!")]] boost::shared_ptr<
        ChimeraTK::RegisterAccessor>
     ...
     */
    [[deprecated(
        "Use getRegisterCatalogue() instead and create accessors with get*RegisterAccessor() functions!")]] std::
        list<boost::shared_ptr<ChimeraTK::RegisterAccessor>>
     ...
     */
    template<typename UserType>
    [[deprecated("Use getOneDRegisterAccessor() instead!")]] BufferingRegisterAccessor<UserType>
  ...
  boost::shared_ptr<customClass> Device::getCustomAccessor(
    ...
    std::cerr << "** Usage of deprecated function Device::getCustomAccessor() detected.                          **"
              << std::endl; // LCOV_EXCL_LINE
