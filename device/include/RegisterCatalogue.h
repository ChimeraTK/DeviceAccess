...
public:
  ...
  getRegister(const RegisterPath &registerPathName) const;
  ...
  public:
    ...
    const_iterator(std::vector<boost::shared_ptr<RegisterInfo>>::const_iterator
                       theIterator_)
  ...
  public:
    ...
    iterator(
        std::vector<boost::shared_ptr<RegisterInfo>>::iterator theIterator_)
        : theIterator(theIterator_) {}
    ...
    RegisterInfo &operator*() { return *(theIterator->get()); }
    boost::shared_ptr<RegisterInfo> operator->() { return *theIterator; }
    const boost::shared_ptr<RegisterInfo> &get() { return *theIterator; }
