...
public:
  ...
  [[deprecated("Use getNChannels() instead!")]] size_t
  getNumberOfDataSequences() const { return get()->getNumberOfChannels(); }
  ...
  [[deprecated("Use getNElementsPerChannel() instead!")]] size_t
  getNumberOfSamples() const { return get()->getNumberOfSamples(); }
