...
namespace ChimeraTK {
  ...
  /** \brief DEPRECATED! Use OneDRegisterAccessor or ScalarRegisterAccessor
   * instead! \deprecated This class is deprecated. Use OneDRegisterAccessor or
   * ScalarRegisterAccessor instead!
   ...
   public:
    ...
    : NDRegisterAccessorAbstractor<UserType>(impl) {
      if(boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)->getNumberOfChannels() != 1) {
        throw ChimeraTK::logic_error("The BufferingRegisterAccessor has a too "
                                     "low dimension to access this register.");
      }
    }
     ...
     *  @todo Add printed runtime warning after release of version 0.9
     */
    operator UserType&() { return boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)->accessData(0, 0); }
    ...
    iterator begin() {
      return boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)->accessChannel(0).begin();
    }
    const_iterator begin() const {
      return boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)->accessChannel(0).cbegin();
    }
    ...
    const_iterator end() const {
      return boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)->accessChannel(0).cend();
    }
    const_iterator cend() const {
      return boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)->accessChannel(0).cend();
    }
    reverse_iterator rbegin() {
      return boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)->accessChannel(0).rbegin();
    }
    const_reverse_iterator rbegin() const {
      return boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)->accessChannel(0).crbegin();
    }
    const_reverse_iterator crbegin() const {
      return boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)->accessChannel(0).crbegin();
    }
    reverse_iterator rend() {
      return boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)->accessChannel(0).rend();
    }
    const_reverse_iterator rend() const {
      return boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)->accessChannel(0).crend();
    }
     ...
     *  @todo Add printed runtime warning after release of version 0.9
     */
    bool isReadOnly() const { return boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)->isReadOnly(); }
     ...
     *  @todo Add printed runtime warning after release of version 0.9
     */
    bool isReadable() const { return boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)->isReadable(); }
     ...
     *  @todo Add printed runtime warning after release of version 0.9
     */
    bool isWriteable() const { return boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)->isWriteable(); }
     ...
     *  @todo Add printed runtime warning after release of version 0.9
     */
    bool isInitialised() const { return boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl) != NULL; }
