...
public:
  ...
  BufferingRegisterAccessor(
    ...
    if (boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)
  ...
  UserType &operator[](unsigned int index) {
    return boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)
        ->accessData(0, index);
  }
  ...
  BufferingRegisterAccessor<UserType> &operator=(UserType rightHandSide) {
    boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)->accessData(
        0, 0) = rightHandSide;
    return *this;
  }
  ...
  BufferingRegisterAccessor<UserType> &operator++() {
    return operator=(
        boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)
            ->accessData(0, 0) +
        1);
  }
  ...
  UserType operator++(int) {
    UserType v = boost::static_pointer_cast<NDRegisterAccessor<UserType>>(_impl)
                     ->accessData(0, 0);
    operator=(v + 1);
    return v;
  }
