...
namespace ChimeraTK {
	...
	inline void DataConsistencyGroup::add(boost::shared_ptr<TransferElement> element) { add(TransferElementAbstractor(element)); }
	...
	{
		throw ChimeraTK::logic_error(
			  "DataConsistencyGroup::getLatestConsistentState() is not implemented jet.");
	}
