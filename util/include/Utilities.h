...
namespace ChimeraTK {
  ...
  class Utilities {
    ...
    public:
      ...
      /** Check whether the given string seems to be a CDD. There is no guarantee that the CDD is well-formed, the
      ...
      /** Check wehter the given string seems to be an SDM. There is no guarantee that the SDM is well-formed, the
       *  finction just looks for the signatore of an SDM. */
