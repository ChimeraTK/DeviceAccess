...
class DemoDummy : public mtca4u::DummyBackend {
  public:
...
DemoDummy::BackendRegisterer::BackendRegisterer() {
    ...
    mtca4u::BackendFactory::getInstance().registerBackendType("DemoDummy","",&DemoDummy::createInstance, CHIMERATK_DEVICEACCESS_VERSION);
}
